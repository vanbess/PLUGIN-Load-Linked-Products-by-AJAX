...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
<script id="sbwc-linked-ajax-load-js" async="false" data-av-variations="<?php echo wc_esc_json(wp_json_encode($linked_products_ajax_variations)); ?>">
    (function($) {

        // available variations
        let available_variations = $('#sbwc-linked-ajax-load-js').attr('data-av-variations');
        ...
        let to_replace = $('#product-' + <?php echo $linked_product_id_initial; ?>);
